...
xgboost_model.load_model("Models_3sec/TrainedModels/XGBmodel.json")

random_forest_model = load("Models_3sec/TrainedModels/RandomForestmodel.pkl")

svm_model_poly = load("Models_3sec/TrainedModels/SVMPolymodel.pkl")

svm_model_rbf = load("Models_3sec/TrainedModels/SVMRbfmodel.pkl")

knn_model = load("Models_3sec/TrainedModels/KNNModel.pkl")

bayes_model = load("Models_3sec/TrainedModels/Bayes.pkl")

# Load dataset from CSV files
X = np.loadtxt('Models_3sec/Data/data.csv', delimiter='\t')
y = np.loadtxt('Models_3sec/Data/labels.csv', delimiter='\t')
