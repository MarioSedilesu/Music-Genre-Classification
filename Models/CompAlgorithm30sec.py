...
xgboost_model.load_model("Models_30sec/TrainedModels/XGBmodel.json")

random_forest_model = load("Models_30sec/TrainedModels/RandomForestmodel.pkl")

svm_model_poly = load("Models_30sec/TrainedModels/SVMPolymodel.pkl")

svm_model_rbf = load("Models_30sec/TrainedModels/SVMRbfmodel.pkl")

knn_model = load("Models_30sec/TrainedModels/KNNModel.pkl")


bayes_model = load("Models_30sec/TrainedModels/Bayes.pkl")

# Load dataset from CSV files
X = np.loadtxt('Models_30sec/Data/data.csv', delimiter='\t')
y = np.loadtxt('Models_30sec/Data/labels.csv', delimiter='\t')
...
# Read labels
data = pd.read_csv('Data/features_30_sec.csv', delimiter=',')
