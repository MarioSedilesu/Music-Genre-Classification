...
param_grid = {
    'C': uniform(loc=0.1, scale=1000),  # Uniform distribution for the regularization parameter C
    'gamma': uniform(loc=0.0001, scale=10)  # Uniform distribution for the gamma parameter
}
